...
function init(){
  ...
  gui.add(options, 'name', ['california', 'triangle', 'heart', 'square', 'rectangle', 'rounded rectangle', 'track', 'circle', 'fish', 'arc circle', 'smiley', 'spline', 'diamond']).onChange(value=>createMesh(value, options.type));
